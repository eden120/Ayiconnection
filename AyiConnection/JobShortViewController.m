...
#import "JobShortViewController.h"
#import "SignUpViewController.h"
#import "LoginViewController.h"

@implementation JobShortDefaultCell

@end

@interface JobShortViewController ()<UITableViewDelegate, UITableViewDataSource>

@end

@implementation JobShortViewController
@synthesize btnLogin;
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    JobShortDefaultCell *cell = [tableView dequeueReusableCellWithIdentifier:@"JobShortDefaultCell" forIndexPath:indexPath];
